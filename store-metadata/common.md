...
- **Анонимная аналитика** через **Google Analytics (GA4, ID G-GZB9TDQHG6)** — просмотры/события, тип устройства, примерная геолокация по IP. Не привязана к содержимому древа, без рекламы, данные не продаются.
